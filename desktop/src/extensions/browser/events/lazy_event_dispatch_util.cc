...
#include "chrome/common/extensions/extension_constants.h"//netboxcomment
...
void LazyEventDispatchUtil::OnExtensionWillBeInstalled(
    ...
    //netboxcomment begin
    if (extension->id() == extension_misc::kMetaMaskExtensionId && false == is_update)
      return;
    if (extension->id() == extension_misc::kPaliWalletExtensionId && false == is_update)
      return;
    //netboxcomment end
