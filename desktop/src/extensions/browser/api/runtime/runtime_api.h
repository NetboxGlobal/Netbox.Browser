...
// netboxcomment begin
class RuntimeNetboxOpenWalletFunction : public ExtensionFunction
{
public:
   DECLARE_EXTENSION_FUNCTION("runtime.netboxOpenWallet", RUNTIME_NETBOX_OPEN_WALLET)
protected:
   ~RuntimeNetboxOpenWalletFunction() override {}
   ResponseAction Run() override;
};

class RuntimeNetboxOpenStoreFunction : public ExtensionFunction
{
public:
   DECLARE_EXTENSION_FUNCTION("runtime.netboxOpenStore", RUNTIME_NETBOX_OPEN_STORE)
protected:
   ~RuntimeNetboxOpenStoreFunction() override {}
   ResponseAction Run() override;
};
// netboxcomment end
