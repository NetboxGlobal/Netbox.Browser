...
const wchar_t kClientsKeyBase[] = L"Software\\NetboxBrowser\\Update\\Clients";
// The path to the key containing each app's Client State registry key.
// No trailing slash on this one because the app's GUID is not appended.
const wchar_t kClientStateKeyBase[] = L"Software\\NetboxBrowser\\Update\\ClientState";
// The path to the key in which kCleanupRegistryValue is found.
const wchar_t kCleanupRegistryKey[] = L"Software\\NetboxBrowser";
#endif
