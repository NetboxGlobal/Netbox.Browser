...
//start wallet (not used)
const char kStartWallet[] = "start-wallet";
...
const wchar_t kChromeExe[] = L"netboxbrowser.exe";
const wchar_t kChromeNewExe[] = L"new_netboxbrowser.exe";
const wchar_t kChromeOldExe[] = L"old_netboxbrowser.exe";
