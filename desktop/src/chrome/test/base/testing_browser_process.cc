...
//netboxcomment begin
Netboxglobal::WalletManager* TestingBrowserProcess::wallet_manager() const
{
    return nullptr;
}

Netboxglobal::WalletSessionManager* TestingBrowserProcess::env_controller() const
{
    return nullptr;
}

Netboxglobal::TransactionService* TestingBrowserProcess::transaction_service() const
{
    return nullptr;
}
