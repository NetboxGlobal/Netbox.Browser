...
#include "chrome/installer/util/auto_launch_util.h"//netboxcomment
...
int main() {
  ...
  // netboxglobal begin
  bool is_browser_process = process_type.empty() || 0 == process_type.compare("browser");

  if ( is_browser_process )
  { 
    auto_launch_util::EnableBackgroundStartAtLogin(); 
  } 
  // netboxglobal end
