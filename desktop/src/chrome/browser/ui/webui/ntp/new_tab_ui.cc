...
std::string NewTabUI::NewTabHTMLSource::GetContentSecurityPolicy(
  ...
  if (directive == network::mojom::CSPDirectiveName::ScriptSrc) {
    ...
    return "script-src chrome://resources 'self' 'unsafe-eval' 'unsafe-inline' "
          "devcryptonews.netbox.global cryptonews.netbox.global " // netbox
    ...
    return "child-src https://cryptonews.netbox.global https://devcryptonews.netbox.global chrome-search://most-visited;"; // netboxcomment
  } else if (directive ==
