...
#ifndef NETBOXGLOBAL_BUILD // netboxcomment
...
// netboxcomment begin
    ...
    {
        html_source->AddString("netboxenv", "netboxqa");
    }
    else
    {
        html_source->AddString("netboxenv", "netbox");
    }
// netboxcomment end
...
//netboxcomment begin
base::RefCountedMemory* WelcomeUI::GetFaviconResourceBytes(ui::ScaleFactor scale_factor)
{
