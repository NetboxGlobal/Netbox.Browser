...
void AddPrivacyStrings(content::WebUIDataSource* html_source,
  ...
  base::ReplaceSubstringsAfterOffset(&s, 0, u"<a ", u"<a style=\"display:none\" ");
  html_source->AddString("doNotTrackDialogMessage", s);
  /* netboxcomment end */  
