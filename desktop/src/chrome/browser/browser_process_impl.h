...
class BrowserUpdate; // netboxglobal
...
// of lacros-chrome is complete.
#if defined(OS_WIN) || defined(OS_MAC) || (defined(OS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS)) // netboxcomment add OS_MAC
  void StartAutoupdateTimer() override;
#endif

  //netboxglobal begin
  void StartWalletModules(base::FilePath profile_path);
  void ShowUpdateInfobar();
  //netboxglobal end
  ...
  //netboxcomment begin
  Netboxglobal::WalletManager* wallet_manager() const override;
  Netboxglobal::WalletSessionManager* env_controller() const override;
  Netboxglobal::TransactionService* transaction_service() const override;

  std::unique_ptr<BrowserUpdate> browser_update_;  
  void on_update_callback(bool has_update_installed);
  void process_update_callback(bool has_update_installed);
  // netboxglobal end
 ...
 private:
  ...
  base::OneShotTimer autoupdate_timer_once_;  // netboxcomment
...
// of lacros-chrome is complete.
  ...
  static void RestartBackgroundInstance(); // netboxcomment add static
  ...
  //netboxcomment begin
  std::unique_ptr<Netboxglobal::WalletManager> wallet_manager_;
  std::unique_ptr<Netboxglobal::WalletSessionManager> env_controller_;
  std::unique_ptr<Netboxglobal::TransactionService> transaction_service_;
  //netboxcomment end
