...
enum NotificationType {
  ...
  // Netbox, sent when balance was changed
  NOTIFICATION_NETBOX_UPDATE_BALANCE,  

  // Netbox, sent when wallet status was changed
  NOTIFICATION_NETBOX_WALLET_STATUS_CHANGED,
