...
extern const char kChromeUIWalletDebugHost[];
extern const char kChromeUIWalletDebugURL[];
extern const char kChromeUINetboxinfoHost[];
extern const char kChromeUINetboxinfoURL[];
extern const char kChromeUIDapstoreHost[];
extern const char kChromeUIDapstoreURL[];
extern const char kChromeUINewsHost[];
extern const char kChromeUINewsURL[];
//netboxcomment end
