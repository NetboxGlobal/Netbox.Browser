...
#define PRODUCT_STRING "NetboxBrowser"
#else
...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("netboxbrowser");
...
#elif defined(OS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("netboxbrowser");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("netboxbrowser");
#endif  // OS_*
