...
const char kChromeUIWalletURL[] = "chrome://wallet/";

const char kChromeUIWalletDebugHost[] = "debugwallet";
const char kChromeUIWalletDebugURL[] = "chrome://debugwallet/";

const char kChromeUINetboxinfoHost[] = "netboxinfo";
const char kChromeUINetboxinfoURL[] = "chrome://netboxinfo/";

const char kChromeUIDapstoreHost[] = "dapp-store";
const char kChromeUIDapstoreURL[] = "chrome://dapp-store/";

const char kChromeUINewsHost[] = "news";
const char kChromeUINewsURL[] = "chrome://news/";
//netboxcomment end
