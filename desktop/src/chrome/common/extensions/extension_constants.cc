...
//netboxcomment begin
const char kIOSTExtensionId[] = "kncchdigobghenbbaddojjnnaogfppfj";
const char kMetaMaskExtensionId[] = "nkbihfbeogaeaoehlefnkodbefgpgknn";
const char kPaliWalletExtensionId[] = "mgffkfbidihjpoaomajlbgchddlicgpn";
//netboxcomment end
