...
const wchar_t kProductPathName[] = L"NetboxBrowser";

const size_t kProductPathNameLength = _countof(kProductPathName) - 1;

const char kSafeBrowsingName[] = "NetboxBrowser";
...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Chromium.
    {
        ...
        L"NetboxBrowser",  // A distinct base_app_name.
        L"NetboxBrowser",  // A distinct base_app_id.
        L"NetboxHTM",                             // ProgID prefix.
        L"NetboxBrowser HTML Document",                  // ProgID description.
        L"{BC0C7762-0263-4D41-ADE3-E9982903062F}",  // Active Setup NetboxGlobal GUID.
        L"{68B94ECC-DD6E-410F-B9FE-7EF688CAC1BB}",  // CommandExecuteImpl NetboxGlobal CLSID.
        {0x635EFA6F,
         0x08D6,
         0x4EC9,
