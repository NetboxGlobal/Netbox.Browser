...
#include "base/system/sys_info.h" // netbox
...
bool IsAImageReaderEnabled() {
  ...
  base::SysInfo::OperatingSystemVersionNumbers(&os_major_version, &os_minor_version, &os_bugfix_version);

  if (9 == os_major_version && "aarch64" == base::SysInfo::OperatingSystemArchitecture())
  {
      return false;
  }
  // netboxcomment end
