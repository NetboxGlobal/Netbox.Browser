...
BrowserProcessImpl::BrowserProcessImpl(StartupData* startup_data)
  ...
  //netboxcomment begin
  transaction_service_ = std::make_unique<Netboxglobal::TransactionMobileService>();
...
Netboxglobal::TransactionMobileService* BrowserProcessImpl::transaction_service() const
{
