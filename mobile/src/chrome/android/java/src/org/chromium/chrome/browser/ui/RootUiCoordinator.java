...
import org.chromium.chrome.browser.netboxwalletbutton.WalletButtonController; // netboxcomment
...
public class RootUiCoordinator
    ...
    protected void initializeToolbar() {
        try (TraceEvent te = TraceEvent.scoped("RootUiCoordinator.initializeToolbar")) {
		    ...
		    /* netboxcomment */
            WalletButtonController walletButtonController = new WalletButtonController(
                    mActivity,
                    mActivityTabProvider);
            /* netboxcomment */

            mButtonDataProviders = Arrays.asList(
                    walletButtonController, // netboxcomment
