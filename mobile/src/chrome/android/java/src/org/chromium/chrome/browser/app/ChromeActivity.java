...
import org.chromium.chrome.browser.netbox.NetboxReferrer;
...
public abstract class ChromeActivity<C extends ChromeActivityComponent>
    ...
    private boolean mHasFocus; // netbox
    ...
    public void performPreInflationStartup() {
        ...
        // netboxcomment
        NetboxReferrer.getInstance().initReferrer(this);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (mNativeInitialized){
            NetboxActivityHelper.OnFocus(mHasFocus);
        }
        // end netbox
