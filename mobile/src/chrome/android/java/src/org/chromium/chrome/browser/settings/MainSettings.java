...
public class MainSettings extends PreferenceFragmentCompat
    ...
    private void createPreferences() {
        ...
        if (ChromeFeatureList.isEnabled(ChromeFeatureList.MOBILE_IDENTITY_CONSISTENCY)) {
            ...
            // netboxcomment findPreference(PREF_ACCOUNT_AND_GOOGLE_SERVICES_SECTION).setVisible(true);
            // netboxcomment mManageSync.setVisible(true);
            // netboxcomment findPreference(PREF_GOOGLE_SERVICES).setVisible(true);
        }
    ...
    private void updatePreferences() {
        if (IdentityServicesProvider.get()
                        ...
                        .isSigninSupported()) {
            // netbox addPreferenceIfAbsent(PREF_SIGN_IN);
