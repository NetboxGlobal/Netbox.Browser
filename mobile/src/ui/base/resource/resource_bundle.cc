...
// begin netboxglobal
bool ResourceBundle::translate(const base::string16& src, base::string16& dst)
{
    if (!re_.get())
    {
        return false;
    ...
    if(src.find_first_of(base::ASCIIToUTF16("Chrome")) == base::string16::npos && src.find_first_of(base::ASCIIToUTF16("Chromium")) == base::string16::npos)
    {
        return false;
    }
...
base::string16 ResourceBundle::GetLocalizedStringImpl(int resource_id) { // netboxcomment remove const
