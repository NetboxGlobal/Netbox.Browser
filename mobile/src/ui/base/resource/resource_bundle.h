...
class COMPONENT_EXPORT(UI_BASE) ResourceBundle {
 ...
 private:
  ...
  base::string16 MaybeMangleLocalizedString(const base::string16& str); // netboxcomment remove const
  ...
  base::string16 GetLocalizedStringImpl(int resource_id); // netboxcomment remove const
  ...
  // begin netboxglobal
  bool translate(const base::string16& src, base::string16& dst);

  std::unique_ptr<icu::RegexMatcher> re_;
  std::map<base::string16, base::string16> translations_;
  // end netboxglobal
